      ...
      {carbs !== null ? (
        ...
        <p className="leading-7 [&:not(:first-child)]:mt-6">
          ...
          <ul className="list-disc pl-6">
            <li>{decimalTime(form.getValues()).["20m"]}g every 20 minutes</li>
            <li>{decimalTime(form.getValues()).["30m"]}g every 30 minutes</li>
            <li>{decimalTime(form.getValues()).["60m"]}g every hour</li>
          </ul>
        </p>
        </>
      ) : ((
