...
import { calculateCarbs, formatHourAndMinuteToHourDecimal } from "@/lib/utils";
...
export default function CarbCalculatorPage() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const timeToDecimal = formatHourAndMinuteToHourDecimal(values.workoutDuration.hours, values.workoutDuration.minutes);
  }
      ...
      {carbs !== null ? (
        ...
        <p className="leading-7 [&:not(:first-child)]:mt-6">
          ...
          This means you should take in: <br />
              {carbs !== null
              ? `${Math.round(carbs / (values.workoutDuration.hours * 3 + (values.workoutDuration.minutes / 20)))}g every 20 minutes`
              : "..."}
        </p>
        </>
      ) : ((
