...
export default function CarbCalculatorPage() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    carbDosageToTime(values);

    setDecimalTime(formatHourAndMinuteToHourDecimal(values.workoutDuration.hours, values.workoutDuration.minutes))
  }
    ...
    <>
      ...
      {carbs !== null ? (
        ...
        <p className="leading-7 [&:not(:first-child)]:mt-6">
          You should consume {carbs !== null ? `~${carbs}g` : "..."} of carbohydrates for
          your workout.
          <br />
          This means you should take in: <br />
          <ul className="list-disc pl-6">
            <li>{carbDosageToTime(form.getValues()).["20m"]}g every 20 minutes</li>
            <li>{carbDosageToTime(form.getValues()).["30m"]}g every 30 minutes</li>
            <li>{carbDosageToTime(form.getValues()).["60m"]}g every hour</li>
          </ul>
        </p>
        </>
      ) : ((
