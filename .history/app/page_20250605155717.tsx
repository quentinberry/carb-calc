    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-[32px] row-start-2 items-start sm:items-start">
        ...
        <p className="leading-7 [&:not(:first-child)]:mt-6">
          Diese Seite hilft Ihnen, die richtige Menge an Kohlenhydraten zu finden, die Sie essen müssen, um während Ihres Trainings Energie zu behalten.
        </p>
        <h2 className="scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0">
          Wie viele Kohlenhydrate brauche ich?
        </h2>
        <p className="leading-7 [&:not(:first-child)]:mt-6">
          Ihr Kohlenhydratbedarf hängt von Ihrem Gewicht, der Intensität und Dauer Ihres Trainings ab. Im Allgemeinen sollten Sie 30-60g Kohlenhydrate pro Stunde für Trainings über eine Stunde konsumieren.
          <br /><br />
          Energiegels sind praktisch, aber teuer; überlegen Sie, Ihre eigenen herzustellen, um eine kostengünstige Option zu haben.
        </p>
        <h2 className="scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0">
          Berechnen wir Ihren Kohlenhydratbedarf!
        </h2>
        <CarbCalculatorPage />
      </main>
    </div>
